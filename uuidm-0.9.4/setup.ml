...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51d778fdfe8172d2ccda1fd92bc533e4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.3";
          ocaml_version = Some (OASISVersion.VGreaterEqual "3.10.0");
          ...
          license_file = None;
          copyrights = ["(c) 2008-2012 Daniel C. Bünzli"];
          maintainers = [];
          authors = ["Daniel Bünzli <daniel.buenzli at erratique.ch>"];
          homepage = Some "http://erratique.ch/software/uuidm";
            ...
            [
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://erratique.ch/repos/uuidm.git";
                      src_repo_browser =
                        Some "http://erratique.ch/repos/uuidm";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "uuidm"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "uuidtrip.ml"; });
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "Uuidm's documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "perf.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "\"Uuidm's README and CHANGES files\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
